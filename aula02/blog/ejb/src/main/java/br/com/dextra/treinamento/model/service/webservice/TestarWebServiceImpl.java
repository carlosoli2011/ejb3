...
public class TestarWebServiceImpl implements TesteWebServiceInterface{
	...
	@WebMethod
	@Override
	public void criarPost(@WebParam(name = "Titulo") String titulo, @WebParam(name = "Descricao")String descricao) {
